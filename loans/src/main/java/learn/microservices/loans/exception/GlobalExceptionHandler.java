package learn.microservices.loans.exception;

import jakarta.validation.ConstraintViolationException;
import learn.microservices.loans.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleLoanAlreadyExistException(LoanAlreadyExistException ex, WebRequest req) {
        ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO(
                req.getDescription(false),
